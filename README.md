...
## What is pokeemerald-expansion-regions?

pokemerald-expansion-regions is a WIP attempt at creating a modular system to load and add multiple regions all within the emerald engine with all the QoL features of pokeemerald-expansion.

My goal is to have Kanto, Johto, Hoenn, and Sevii Islands all in one game.
